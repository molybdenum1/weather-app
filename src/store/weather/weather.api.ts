...
import { iWeather5Days } from './weather5forecast.types';
...
export const weatherApi = createApi({
    ...
    endpoints: (builder) => ({
        ...
        get5DayWeatherByCity: builder.query<iWeather5Days, string | undefined>({
            query: (city) => `forecast?appid=9b4d258b0805206bc644291830b014ff&q=${city}`
        })
    }),
})

export const { useGetWeatherByCityQuery, useGet5DayWeatherByCityQuery } = weatherApi;